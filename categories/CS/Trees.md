...
**Double** rotation, **double** direction

First in the direction of the subtree, then in the direction of the child. 

* Left subtree, right child. 
    * For example, this would be a left-right rotation
...
* $O(n)$  worst case
* $\Theta (1)$ *amortized* for many ops 
